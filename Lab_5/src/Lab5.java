...
class Rab3 extends  Thread {
    ...
    public void run() {
        /*
        for (; Lab5.arr3.size() >= 1;) {
            System.out.println("Работник 3: " + Lab5.arr3.get(0));
            Lab5.arr3.remove(0);
            try {
                Rab3.sleep(200 );
            } catch (InterruptedException e) {
            ...
            //Lab5.arr2.add(Lab5.arr1.get(i));
        }
        */
        /*for (int i = 0; i <= Lab5.c; i++){
            System.out.println("Работник 3: " + i);
            //Lab5.c = i;
            //new Rab2().start();
        }*/
...
public class Lab5 {
    ...
    //public static ArrayList<Integer> arr3;
    ...
    public static void main(String[] args) {
        ...
        Lab5.h = in.nextInt();
        //Lab5.arr1 = new ArrayList<Integer>();
        //Lab5.arr2 = new ArrayList<Integer>();
        //Lab5.arr3 = new ArrayList<Integer>();
        //for (int i = 0; i <= Lab5.h - 1; i++)
        //    Lab5.arr1.add(i+1);
